...
- [content](https://github.com/stalniy/rollup-plugin-content) - Generates assets out of markdown (and not only) files to be used as content for custom static web site. Also can be used to create search index for Client Based Full Text Search.
